...
router.get("/manager/jobs/:id", verifyToken, authorize("hiring-manager"), controller.getJob);
router.patch("/jobs/:id", verifyToken, authorize("hiring-manager"), controller.updateJob);
